...
const formSchema = z
  .object({
    ...
    estimatedDeliveryTime: z.coerce.number({
      required_error: "estimated delivery time is requried",
      invalid_type_error: "must be a valid number",
    }),
    cuisines: z
      .array(z.string())
      .nonempty({ message: "pleaser select aat least one item" }),
    menuItems: z.array(
      z.object({
...
const ManageRestaurantForm = ({ restaurant, onSave, isLoading }: Props) => {
  ...
  function onSubmit(formDataJson: z.infer<typeof formSchema>) {
